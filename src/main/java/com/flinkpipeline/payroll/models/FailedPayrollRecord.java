 ...
 * Contains the original employee record, validation results, HR workflow information,
 * and correction guidance for payroll data quality management.
 */
public class FailedPayrollRecord {
  ...
  public static FailedPayrollRecord fromValidationResult(PayrollEmployee employee, PayrollValidationResult result) {
  ...
  public PayrollValidationResult getValidationResult() { return validationResult; }
  public Instant getFailureTimestamp() { return failureTimestamp; }
  public long getProcessingLatencyMs() { return processingLatencyMs; }
  public String getHrWorkflowId() { return hrWorkflowId; }
  public Priority getCorrectionPriority() { return correctionPriority; }
  public RiskLevel getComplianceRiskLevel() { return complianceRiskLevel; }
  public CorrectionStatus getCorrectionStatus() { return correctionStatus; }
  public Integer getEstimatedCorrectionTimeMinutes() { return estimatedCorrectionTimeMinutes; }
  ...
  public String getHrCorrectionInstructions() { return hrCorrectionInstructions; }
  public String getPrimaryFailureReason() { return primaryFailureReason; }
  public String getBusinessImpactDescription() { return businessImpactDescription; }
  public Integer getCorrectionAttempts() { return correctionAttempts; }
  public Instant getLastCorrectionAttempt() { return lastCorrectionAttempt; }
  public String getAssignedHRUser() { return assignedHRUser; }
  public Instant getHrResponseDeadline() { return hrResponseDeadline; }
  ...
  public FailedPayrollRecord withResolution() {
    return new Builder(this)
        .correctionStatus(CorrectionStatus.RESOLVED)
        .build();
  }
  ...
  private static String generateCorrectionInstructions(PayrollValidationResult result) {
    ...
    for (FieldValidationResult fieldResult : result.getFieldResults()) {
      if (fieldResult.isFailed()) {
        instructions.append("Field: ").append(fieldResult.getFieldName().toUpperCase()).append("\n");
  ...
  private static String determinePrimaryFailureReason(PayrollValidationResult result) {
    ...
    for (FieldValidationResult fieldResult : result.getFieldResults()) {
      if (fieldResult.isFailed() && fieldResult.getComplianceLevel() == FieldValidationResult.ComplianceLevel.REGULATORY) {
  ...
  public static class Builder {
    ...
    public Builder originalRecord(PayrollEmployee originalRecord) { this.originalRecord = originalRecord; return this; }
    public Builder validationResult(PayrollValidationResult validationResult) { this.validationResult = validationResult; return this; }
    public Builder failureTimestamp(Instant failureTimestamp) { this.failureTimestamp = failureTimestamp; return this; }
    public Builder processingLatencyMs(long processingLatencyMs) { this.processingLatencyMs = processingLatencyMs; return this; }
    public Builder hrWorkflowId(String hrWorkflowId) { this.hrWorkflowId = hrWorkflowId; return this; }
    public Builder correctionPriority(Priority correctionPriority) { this.correctionPriority = correctionPriority; return this; }
    public Builder complianceRiskLevel(RiskLevel complianceRiskLevel) { this.complianceRiskLevel = complianceRiskLevel; return this; }
    public Builder correctionStatus(CorrectionStatus correctionStatus) { this.correctionStatus = correctionStatus; return this; }
    public Builder estimatedCorrectionTimeMinutes(Integer estimatedCorrectionTimeMinutes) { this.estimatedCorrectionTimeMinutes = estimatedCorrectionTimeMinutes; return this; }
    public Builder validationErrors(List<String> validationErrors) { this.validationErrors = new ArrayList<>(validationErrors); return this; }
    public Builder complianceFlags(List<String> complianceFlags) { this.complianceFlags = new ArrayList<>(complianceFlags); return this; }
    public Builder hrCorrectionInstructions(String hrCorrectionInstructions) { this.hrCorrectionInstructions = hrCorrectionInstructions; return this; }
    public Builder primaryFailureReason(String primaryFailureReason) { this.primaryFailureReason = primaryFailureReason; return this; }
    public Builder businessImpactDescription(String businessImpactDescription) { this.businessImpactDescription = businessImpactDescription; return this; }
    public Builder correctionAttempts(Integer correctionAttempts) { this.correctionAttempts = correctionAttempts; return this; }
    public Builder lastCorrectionAttempt(Instant lastCorrectionAttempt) { this.lastCorrectionAttempt = lastCorrectionAttempt; return this; }
    public Builder assignedHRUser(String assignedHRUser) { this.assignedHRUser = assignedHRUser; return this; }
    public Builder hrResponseDeadline(Instant hrResponseDeadline) { this.hrResponseDeadline = hrResponseDeadline; return this; }
