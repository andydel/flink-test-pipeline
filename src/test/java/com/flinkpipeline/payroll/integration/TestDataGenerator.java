...
/**
 * Test data generator for integration testing. Generates various types of payroll employee records
...
public class TestDataGenerator {
  ...
  public List<PayrollEmployee> generateInvalidRecords(int count) {
    ...
    for (int i = 0; i < count; i++) {
      PayrollEmployee.Builder builder = PayrollEmployee.builder().employeeId(20000 + i);

      // Introduce various validation errors
      switch (i % 5) {
        case 0: // Missing required fields
          builder.firstName("").lastName(getRandomLastName()).age(25);
          break;
  ...
  public List<PayrollEmployee> generatePerformanceTestRecords(int count) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      PayrollEmployee.Builder builder =
          PayrollEmployee.builder()
              .employeeId(40000 + i)
  ...
  public List<PayrollEmployee> generateDuplicateTestRecords(
      int uniqueCount, int duplicatesPerRecord) {
    List<PayrollEmployee> records = new ArrayList<>();
        ...
        PayrollEmployee duplicate =
            PayrollEmployee.builder()
                ...
                .ingestionTimestamp(
                    Instant.now()
                        .plusSeconds(i * 10)
                        .toEpochMilli()) // Slightly different timestamps
                .build();
